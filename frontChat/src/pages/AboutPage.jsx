    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <div className="inline-flex items-center justify-center space-x-3 bg-white px-6 py-3 rounded-full shadow-lg mb-6">
            <Sparkles className="w-6 h-6 text-purple-600" />
            <span className="text-lg font-bold gradient-text">IA Jeunes</span>
          </div>
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Une initiative du défi national pour démocratiser l'enseignement de l'intelligence artificielle 
            auprès des jeunes de manière ludique et accessible.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16 animate-slide-up">
          {features.map((feature, index) => (
            <div key={index} className="bg-white rounded-xl shadow-lg p-8 text-center">
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 w-16 h-16 rounded-full flex items-center justify-center text-white mx-auto mb-4">
                {feature.icon}
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-16 animate-fade-in">
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            <p className="text-gray-600 text-lg">
              <strong className="text-gray-900">IA Jeunes</strong> est née d'un constat simple : 
            ...
            <p className="text-gray-600 text-lg">
              Dans le cadre du <strong className="text-gray-900">Défi National d'Éducation à l'IA</strong>, 
            ...
            <p className="text-gray-600 text-lg">
              Notre approche pédagogique privilégie l'<strong className="text-gray-900">apprentissage par la pratique</strong> : 
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-xl p-8 md:p-12 mb-16 text-white animate-fade-in">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <h3 className="text-xl font-bold mb-3">Backend & IA</h3>
              <ul className="space-y-2 text-white/90">
